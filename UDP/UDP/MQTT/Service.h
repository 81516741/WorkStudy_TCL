...
static NSString *const AddressOfMQTTServerTest      = @"testtsound.tclking.com";  //
static NSString *const AddressOfMQTTServer      = @"tsound.tclking.com";  // MQTT服务器地址
static UInt16   const PortOfMQTTServer          = 1883;  // MQTT服务器端口
static UInt16   const PortOfMQTTServerWithSSL          = 8883;  // MQTT服务器端口
