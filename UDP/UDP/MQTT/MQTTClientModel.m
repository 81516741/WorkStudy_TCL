...
- (void)bindWithUserName:(NSString *)username password:(NSString *)password cliendId:(NSString *)cliendId isSSL:(BOOL)isSSL{
    ...
    [self.mySessionManager connectTo:self.isTestServer?AddressOfMQTTServerTest:AddressOfMQTTServer
...
- (void)sessionManager:(MQTTSessionManager *)sessionManager didChangeState:(MQTTSessionManagerState)newState {
    switch (newState) {
        case MQTTSessionManagerStateConnected:
            ...
            [[NSNotificationCenter defaultCenter] postNotificationName:@"kMQTTConnectedSuccessNoti" object:nil];
            break;
