...
-(NSString *)XMLFormatValue:(NSString *)xmlsString
{
    xmlsString = [xmlsString stringByReplacingOccurrencesOfString:@"<xmlValue>" withString:@""];
    xmlsString = [xmlsString stringByReplacingOccurrencesOfString:@"</xmlValue>" withString:@""];
    return xmlsString;
}
...
+ (NSString*) XmlStringFormatValue:(NSString *)xmlString
{
    XMLWriter *xmlFormatString = [[XMLWriter alloc] init];
    return [xmlFormatString XMLFormatValue:xmlString];
}
